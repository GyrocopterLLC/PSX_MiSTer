...
module MT48LC8M16A2 (dq_in, dq_out, addr, ba, clk, cke, csb, rasb, casb, web, dqm);
    ...
    assign    dq_out               = Dq_reg;                        // DQ buffer
    ...
    always @ (posedge Sys_clk) begin
        ...
        if (Data_in_enable == 1'b1) begin                                   // Writing Data to Memory
            ...
            // dqm operation
            if (dqm[0] == 1'b0) Dq_dqm [ 7 : 0] = dq_in [ 7 : 0];
            if (dqm[1] == 1'b0) Dq_dqm [15 : 8] = dq_in [15 : 8];
            // Write to memory
    ...
    specify
        ...
        $setuphold(posedge Dq_chk, dq_in,    tDS,  tDH);
    endspecify
