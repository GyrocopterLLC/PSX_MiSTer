...
VHDL_SOURCES ?= $(PWD)/../rtl/datacache.vhd
VHDL_SOURCES += $(PWD)/../rtl/export.vhd
VHDL_SOURCES += $(PWD)/../sim/system/src/mem/dpram.vhd
VHDL_SOURCES += $(PWD)/../rtl/divider.vhd
VHDL_SOURCES += $(PWD)/../rtl/cpu.vhd
VHDL_SOURCES += $(PWD)/../rtl/memorymux.vhd
VHDL_SOURCES += $(PWD)/cpu_mux_tb.vhd
...
COCOTB_TEST_MODULES = test_cpumux
